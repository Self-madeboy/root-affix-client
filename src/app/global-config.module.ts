...
// TODO功能未测试 三种存储类型 LocalStorageStore 存储，关掉浏览器后不丢失; SessionStorageStore存储，关掉浏览器后丢失;MemoryStore内存存储，关掉浏览器标签后丢失
...
export class GlobalConfigModule {
  ...
  static forRoot(): ModuleWithProviders<GlobalConfigModule> {
    return {
      ...
      providers: [...alainProvides, ...zorroProvides, LocalStorageStore],
    };
  }
}
